...
To understand the results of this project, you need to run the code ordered by Tasks (1 to 5). Task 1 to 4 are Jupyter notebooks and Task 5 is a Python script.
